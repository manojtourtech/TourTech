            ...
            <View style={styles.top}>
                <View style={{ flex: 0.5, backgroundColor: 'red' }}>
                    <ImageBackground
                        ...
                        source={{ uri: 'https://images.unsplash.com/photo-1557862921-37829c790f19?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTN8fGJ1c2luZXNzJTIwbWFufGVufDB8MHwwfHw%3D&auto=format&fit=crop&w=500&q=60' }}>
                        <View style={{ height: vs(25), width: s(150), backgroundColor: '#E6EEF4', borderRadius: 8, justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-end', marginBottom: vs(18), left:'85%' }}>
                ...
                <View style={{ flex: 0.5, backgroundColor: 'pink' }}>
                    <ImageBackground
                        style={styles.backimg}
                        source={{ uri: 'https://images.unsplash.com/photo-1578496781197-b85385c7f0b3?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cGF0aWVudHxlbnwwfDF8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' }}>
                        <Image style={styles.img} source={{ uri: 'https://images.unsplash.com/photo-1618255697744-b45454ae6b39?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fGRvY3RvcnxlbnwwfDF8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' }}></Image>
                        <View style={{height: vs(25), width: s(150), backgroundColor: '#E6EEF4', borderRadius: 8, justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-end', marginBottom: vs(18), left:'31%'  }}>
                            <Text style={styles.text2}>{reverseText('גניסיפידא ררוטקסנוק')}</Text>
                        </View>
