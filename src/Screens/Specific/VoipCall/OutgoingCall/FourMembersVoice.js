    ...
    return (
        ...
        <LinearGradient
            ...
            <View style={styles.top}>
                <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop: vs(27) }}>
                    <View style={{ flexDirection: 'row', }}>
                        <View style={{ flexDirection: 'column', alignItems: 'center' }}>
                            <View style={{ marginTop: vs(12), height: s(70), width: s(70), elevation: 3, backgroundColor: colors.BackgroundColor, borderRadius: 70, justifyContent: 'center', alignItems: 'center' }}>
                                <Avatar.Image
                                    source={{
                            ...
                            <Text style={[styles.text1, { marginTop: vs(7), fontWeight: 'bold' }]}>{reverseText('ררוטקסנוק')}</Text>
                            <Text style={[styles.text1, { marginTop: vs(1), fontWeight: 'bold' }]}>{reverseText('גניסיפידא')}</Text>
                        ...
                        <View style={{ flexDirection: 'column', alignItems: 'center', marginLeft: vs(40), }}>
                            <View style={{ marginTop: vs(12), height: s(70), width: s(70), elevation: 3, backgroundColor: colors.BackgroundColor, borderRadius: 70, justifyContent: 'center', alignItems: 'center' }}>
                                <Avatar.Image
                                    source={{
                            ...
                            <Text style={[styles.text1, { marginTop: vs(7), fontWeight: 'bold' }]}>{reverseText('םייח לפוטמ')}</Text>
                    ...
                    <View style={{ flexDirection: 'column', alignItems: 'center', marginTop: 10 }}>
                        ...
                        <Text style={[styles.text1, { marginTop: vs(7), fontWeight: 'bold' }]}>{reverseText('םייח לפטמ')}</Text>
            ...
            <View style={styles.bottom2}>
                ...
                <Text onPress={() => navigation.navigate('SOSCall')} style={styles.text6}>{reverseText('החיש קתנ')}</Text>
            </View>
        </LinearGradient>
