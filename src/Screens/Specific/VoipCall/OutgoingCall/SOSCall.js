    ...
    return (
        ...
        <LinearGradient
            ...
            <View style={styles.top1}>
                ...
                <View style={{ marginTop: vs(12), height: s(95), width: s(95), elevation: 3, backgroundColor: colors.BackgroundColor, borderRadius: 95, justifyContent: 'center', alignItems: 'center' }}>
                    <Avatar.Image
                        source={{
                ...
                <TouchableOpacity>
                    <View style={{ marginTop: vs(25), height: s(170), width: s(170), elevation: 3, backgroundColor: '#F41032', borderRadius: 170, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View style={styles.bottom3}>
                ...
                <View style={{ flexDirection: 'row', marginTop: vs(30) }}>
                    ...
                    <View style={{ flexDirection: 'column', alignItems: 'center', marginLeft: vs(68) }}>
