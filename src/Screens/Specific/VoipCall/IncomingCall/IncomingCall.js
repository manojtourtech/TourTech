            ...
            <View style={styles.bottom1}>
                ...
                <View style={{ flexDirection: 'row', marginTop: vs(53) }}>
                    <View style={{ flexDirection: 'column', alignItems: 'center', }}>
                        <View style={{ justifyContent: 'center', alignItems: 'center', elevation: 3, width: s(55), height: vs(55), borderRadius: 55, backgroundColor: colors.BackgroundColor }}>
                            <TouchableOpacity>
                                <IconIon
                ...
                <View style={{ flexDirection: 'row', marginTop: 35 }}>
                    <View style={{ flexDirection: 'column', alignItems: 'center' }}>
                        <View style={{ height: s(70), width: s(70), elevation: 3, borderRadius: 70, backgroundColor: '#10B01C', justifyContent: 'center', alignItems: 'center' }}>
                            <TouchableOpacity onPress={() => navigation.navigate('TwoMembersVoice')}>
                                <IconZ
                                    name='call'
                                    size={s(25)}
                    ...
                    <View style={{ flexDirection: 'column', alignItems: 'center', marginLeft: s(60) }}>
