            ...
            <View style={styles.inner}>
                ...
                <View style={{ height: '69%', width: '94%', marginTop: vs(15), alignSelf: 'center' }}>
                    <View style={{ flexDirection: 'row', height: vs(40), width: '94%', alignSelf: 'center', borderWidth: 0.4, borderRadius: 10, borderColor: colors.borderColor }}>
                        <View style={{ flex: 0.5, justifyContent: 'center', alignItems: 'center' }}>
                            <TouchableOpacity onPress={()=> navigation.navigate('SearchAttachment')}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={[styles.listView, { marginTop: vs(16) }]}>
                            <View style={{ flex: 0.79, flexDirection: 'column' }}>
                                <View style={{ flex: 1.5, flexDirection: 'column', justifyContent: 'flex-end', }}>
                                    <Text style={styles.Text2}>{reverseText('ןהכ םייח לפוטמ')}</Text>
                                </View>
                                <View style={{ flex: 1, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ flex: 0.8, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'flex-start' }}>
                                        <Text style={[styles.Text3, { paddingRight: 0 }]}>{reverseText('עמש תחיש')}</Text>
                                    </View>
                            ...
                            <View style={{ flex: 0.21, justifyContent: 'center', alignItems: 'flex-end' }}>
                                <Avatar.Image
                                    style={styles.Avatar}
                                    source={{
