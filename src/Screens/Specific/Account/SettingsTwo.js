                    ...
                    <View style={{marginBottom:5}}>
                        <View style={{ marginTop: 25 }}>
                            ...
                            <View style={Styles.textInput}>
                                <TextInput placeholder={reverseText('לגוג לש הנש חול')} style={Styles.textInputdata}></TextInput>
                            </View>
                            <View style={[Styles.textInput, { marginTop: 15 }]}>
                                <TextInput placeholder={reverseText('רשק ישנאל השיג')} style={Styles.textInputdata}></TextInput>
                            </View>
                        </View>
                        ...
                        <View style={{ marginTop: 35 }}>
                            ...
                            <View style={Styles.textInput}>
                                <TextInput placeholder={reverseText('םילילצ רשפא')} style={Styles.textInputdata}></TextInput>
                            </View>
                            <View style={[Styles.textInput, { marginTop: 15 }]}>
                                <TextInput placeholder={reverseText('טטר רשפא')} style={Styles.textInputdata}></TextInput>
                            </View>
                        </View>
                    </View>
                </ScrollView>
