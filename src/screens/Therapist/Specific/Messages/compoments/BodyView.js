  ...
  return (
    <View>
      {props.lastMessage?.typeID == 5 ? (
        <MessageContainer>
          <Icon source={require('../../../../../assets/images/ic_file.png')} />
          <H1>{props.lastMessage?.body}</H1>
        </MessageContainer>
      ) : props.lastMessage?.typeID == 4 ? (
        <MessageContainer>
          <Icon source={require('../../../../../assets/images/ic_image.png')} />
          <H1>{props.lastMessage?.body}</H1>
        </MessageContainer>
      ) : props.lastMessage?.typeID == 3 ? (
        <MessageContainer>
          <Icon source={require('../../../../../assets/images/ic_video.png')} />
          <H1>{props.lastMessage?.body}</H1>
        </MessageContainer>
      ) : props.lastMessage?.typeID == 2 ? (
        <MessageContainer>
          <Icon source={require('../../../../../assets/images/ic_voice.png')} />
          <H1>{props.lastMessage?.body}</H1>
        </MessageContainer>
      ) : (
        <H1>{props.lastMessage?.body}</H1>
