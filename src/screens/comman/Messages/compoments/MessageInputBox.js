    ...
    <View style={{backgroundColor: '#FFFFFF'}}>
      ...
      <View style={styles.bottomView}>
        <View
          ...
          <View style={styles.InputBox1}>
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../../../../assets/images/ic_emoji.png')}
                style={{
                  width: 24,
                  height: 24,
                  margin: 2,
          ...
          {attachmentPath != '' ? (
            <TouchableOpacity
              ...
              <IconAnt name="arrowup" size={s(20)} color={colors.white} />
            </TouchableOpacity>
          ) : (
            <TouchableOpacity
              onPress={() => {
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <IconFontAwe name="photo" size={s(19)} color={colors.primary} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <IconEnt name="camera" size={s(20)} color={colors.primary} />
          </TouchableOpacity>
          {/* --------------------------------------- */}
      ...
      {showEmojiKeyboard ? (
        <EmojiSelector
          ...
          showHistory={true}
          style={{height: vs(250), backgroundColor: colors.white}}
          columns={9}
          showSearchBar={false}
        />
      ) : null}
