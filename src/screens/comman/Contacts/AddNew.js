...
function reverseText(s) {
  //console.log('Add New', s.split('').reverse().join(''));
    ...
    <View style={styles.container}>
      <View style={styles.topView}>
        <View
          ...
          <Text style={[styles.Text1, {color: colors.primary}]}>
            {reverseText('הרימש')}
          </Text>
        </View>
        <View
      ...
      <View style={styles.Img}>
        <View
          ...
          <IconFont name="user" size={75} color={colors.white} />
        </View>
      ...
      <View style={styles.bottom}>
        <TouchableOpacity
          style={[styles.button1, {backgroundColor: colors.primary}]}>
