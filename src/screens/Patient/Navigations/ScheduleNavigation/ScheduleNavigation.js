                  ...
                  <View style={{flexDirection: 'column', alignItems: 'center'}}>
                    <View
                      ...
                      <Pressable onPress={() => setMood(2)}>
                        <Image
                          source={require('../../../../assets/images/mood2.png')}
                          style={{height: 42, width: 42}}
                        />
                      </Pressable>
                    </View>
                  ...
                  <View style={{flexDirection: 'column', alignItems: 'center'}}>
                    <View
                      ...
                      <Pressable onPress={() => setMood(3)}>
                        <Image
                          source={require('../../../../assets/images/mood3.png')}
                          style={{height: 42, width: 42}}
                        />
                      </Pressable>
                    </View>
                  ...
                  <View style={{flexDirection: 'column', alignItems: 'center'}}>
                    <View
                      ...
                      <Pressable onPress={() => setMood(4)}>
                        <Image
                          source={require('../../../../assets/images/mood4.png')}
                          style={{height: 42, width: 42}}
                        />
                      </Pressable>
                    </View>
                  ...
                  <View style={{flexDirection: 'column', alignItems: 'center'}}>
                    <View
                      ...
                      <Pressable onPress={() => setMood(5)}>
                        <Image
                          source={require('../../../../assets/images/mood5.png')}
                          style={{height: 42, width: 42}}
                        />
                      </Pressable>
                    </View>
