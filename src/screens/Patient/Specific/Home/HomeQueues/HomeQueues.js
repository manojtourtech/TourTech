      ...
      <View style={{flex: 1, margin: 12, justifyContent: 'center'}}>
        ...
        <View style={styles.cardSubView2}>
          ...
          {item.medium === 'location' ? (
            <IconIon name="ios-location-sharp" size={s(22)} color={'#2F950B'} />
          ) : item.medium === 'video' ? (
            <IconFont name="video-camera" size={s(20)} color={'#2F950B'} />
          ) : item.medium === 'audio' ? (
            <IconIon name="ios-call" size={s(20)} color={'#2F950B'} />
          ) : null}
        </View>
      </View>
    </Card>
          ...
          <View style={{marginTop: vs(20), margin: 15}}>
            ...
            <View style={styles.childContainer}>
              ...
              <View style={styles.iconView}>
                <IconFontisto name="doctor" size={s(23)} color={colors.white} />
              </View>
            </View>
