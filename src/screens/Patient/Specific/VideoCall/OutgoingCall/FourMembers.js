        ...
        <View style={{flex: 0.5, flexDirection: 'row'}}>
          ...
          <View style={{flex: 0.5}}>
            <ImageBackground
              style={styles.img2}
              source={{
                uri: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8ZG9jdG9yc3xlbnwwfDF8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
              }}>
              <View
                style={{
                  height: vs(25),
