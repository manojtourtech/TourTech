...
function reverseText(s) {
  //console.log('Setting Comp', s.split('').reverse().join(''));
  ...
  return (
    <View style={Styles.container}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <View style={Styles.MenuButton}>
              <IconEnt name="menu" size={s(23)} color={colors.textColor} />
            </View>
          </TouchableOpacity>
        </View>
      </View>
      <View style={Styles.mid}>
        ...
        <View
          style={{flex: 0.2, justifyContent: 'center', alignItems: 'flex-end'}}>
          <Avatar.Image
            style={{right: 15}}
            source={{
